window.lunrData = {
  "index": {
    ...
    "documentStore": {
      "store": {
        ...
        "PluginController.html#reloadPlugin": [
          "around",
          "boolean",
          "configur",
          "function",
          "headless",
          "hhm",
          "https://github.com/saviola777/haxbal",
          "lt;async&gt",
          "manager/blob/master/src/classes/pluginmanager.js#l565",
          "method",
          "plugin",
        ...
        "Haxroomie.html#createRoomControllerEventHandler": [
          "add",
          "createroomcontrollereventhandl",
          "emit",
          "event",
          "eventnam",
          "function",
          "haxroomi",
          "haxroomie#createroomcontrollereventhandl",
          "instanc",
          "listen",
          "re",
          "room",
                    ...
                    "m": {
                      ...
                      "i": {
                        "docs": {
                          ...
                          "Haxroomie.html#createRoomControllerEventHandler": {
                            "ref": "Haxroomie.html#createRoomControllerEventHandler",
                            "tf": 6.25
                          },
                          "module-haxroomie.html": {
  ...
  "store": {
    ...
    "PluginController.html#setPluginConfig": {
      ...
      "summary": "",
      "description": "Sets the rooms plugin config. Merges the new config with the old one. Tries to load plugins that are not loaded from the available repositories and removes the loaded plugins that are not in the given config. If pluginName is given then only config for the given plugin is set."
    },
    "PluginController.html#getPluginConfig": {
    ...
    "PluginController.html#reloadPlugin": {
      "id": "PluginController.html#reloadPlugin",
      "kind": "function",
      "title": "&lt;async&gt; reloadPlugin( pluginName [, safe ] ) → {boolean}",
      "longname": "PluginController#reloadPlugin",
      "name": "reloadPlugin",
      "tags": "PluginController#reloadPlugin reloadPlugin",
      "summary": "",
    ...
    "Haxroomie.html#createRoomControllerEventHandler": {
      "id": "Haxroomie.html#createRoomControllerEventHandler",
      "kind": "function",
      "title": "createRoomControllerEventHandler( room, eventName )",
      "longname": "Haxroomie#createRoomControllerEventHandler",
      "name": "createRoomControllerEventHandler",
      "tags": "Haxroomie#createRoomControllerEventHandler createRoomControllerEventHandler",
      "summary": "",
      "description": "Adds listener for RoomController that re emits the event from Haxroomie instance."
    },
    "Haxroomie.html#hasRoom": {
